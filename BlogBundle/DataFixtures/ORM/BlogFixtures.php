...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog1->setUrl('a-day-with-symfony2');
        ...
        $blog2->setUrl('the-pool-on-the-roof-must-have-a-leak');
        ...
        $blog3->setUrl('misdirection-what-the-eyes-see-and-the-ears-hear-the-mind-believes');
        ...
        $blog4->setUrl('the-grid-a-digital-frontier');
        ...
        $blog5->setUrl('you-re-either-a-one-or-a-zero-Aalive-or-dead');
